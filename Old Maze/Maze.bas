...
Sub DrawMaze(Dst, txSize As Integer, tySize As Integer, Optional WallColor As Long = vbBlack, Optional FloorColor As Long = vbWhite, Optional SeeDrawing As Boolean = False)
...
If tSeeDrawing Then
    ...
    'Dst.Line (xAdd, yAdd)-(xP * xSize + xAdd, yP * ySize + yAdd), wallcolor, BF
Else
    Dst.Line (0, 0)-(Dst.ScaleWidth, Dst.ScaleHeight), WallColor, BF
